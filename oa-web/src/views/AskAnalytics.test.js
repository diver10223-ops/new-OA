...
async function submit(wrapper, question = '问题') {
...
describe('AskAnalytics', () => {
    ...
    it.each([
        {
            result: { type: 'compare_indicator', indicator: '平均存款', org: '总部', current: 80, previous: 79, difference: 1, changeRate: 0.012658 },
            expected: ['平均存款 · 对比', '1.27%'],
        },
        {
            result: { type: 'read_trend', indicator: '贷款占比', org: '本分行', trend: [{ period: '四月', value: 0.5 }, { period: '六月', value: 0.55 }] },
