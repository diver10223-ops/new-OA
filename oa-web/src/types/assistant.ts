...
export interface IndicatorComparisonResult { type?: 'compare_indicator'; indicator: string; org: string; current: number; previous: number; difference: number; changeRate: number | null; changeRateNote?: string; unit?: string }
