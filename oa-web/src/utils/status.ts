...
const labels: Record<string, string> = { APPROVED:'已通过', EFFECTIVE:'已生效', ESTABLISHED:'已立项', CLOSED:'已结项', PENDING:'审批中', SUBMITTED:'审批中', REJECTED:'已拒绝', CANCELLED:'已撤回', WITHDRAWN:'已撤回', DRAFT:'草稿' }
